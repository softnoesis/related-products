...
class Module extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $productidcollection = $objectManager->get('Magento\Framework\Registry')->registry('current_product');
    ...
    public function getProductcollection()
    {
        ...
        $collection->addAttributeToFilter('entity_id', ['neq' => $this->getCurrentproductid()]);
